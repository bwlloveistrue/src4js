(function() {
          ...
          arrayEach.call(this, roots, function(root, i) {
              ...
              if (id == id && attr !== null && instances[id]) {
                  ...
                  if (params.root && params.scroller) {
                      perInstanceParams.scroller = params.$(
                          params.scroller,
                          root
                      );
  ...
  Item.prototype = {
      ...
      constructor: function(params) {
          ...
          this.clipper =
              (params.notParentClipper && params.clipper) ||
                  ...
                  if (offset) {
                      ...
                      if (self.impact == "scroller") {
                          ...
                          if (self.position == "static") {
                              ...
                              was = self
                                  .$(self.scroller)
                                  .css(self.origin.crossSize);
                              will =
                                  self.clipper[self.origin.crossClient] +
                                  delta +
                                  "px";
          ...
          this.updatePositions = function(force) {
              ...
              if (self.bar) {
                  newBarSize =
                      ((track[self.origin.client] - self.barTopLimit) *
                  ...
                  if (
                      force ||
                      parseInt(oldBarSize, 10) != parseInt(newBarSize, 10)
                  ) {
          ...
          this.clipperOnScroll = function() {
              ...
              if (!this.rtl) {
                  ...
                  this.clipper[this.origin.scrollEdge] = this.clipper[
                      this.origin.scrollSize
                  ];
              }
          };
          ...
          if (isMacFF) {
              ...
              var paddingWas = scopedWindow.getComputedStyle(this.scroller)[
                  [padding]
              ];
      ...
      dispose: function(params) {
          ...
          this.pos = null;
          this.drag = null;
          this.clipperOnScroll = null;
          this.scroll = null;
          this.selection = null;
          this.updatePositions = null;
          this._setCrossSizes = null;
          this.cursor = null;
          this.$ = null;
