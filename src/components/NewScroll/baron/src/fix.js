  ...
  var fix = function(userParams) {
      ...
      function fixElement(i, _pos, flag) {
          ...
          this.$(elements[i])
              ...
              .removeClass(params.outside);

          // Fixing if needed
          if (pos !== undefined) {
              pos += "px";
              this.$(elements[i])
                  .css(this.origin[ori], pos)
                  .addClass(params.outside);
          }
      }
          ...
          if (elements) {
              ...
              for (var i = 0; i < elements.length; i++) {
                  ...
                  pos[this.origin.crossSize] =
                      elements[i].parentNode[this.origin.crossClient];
                  ...
                  headerTops[i] =
                      elements[i].parentNode[this.origin.offsetPos]; // No paddings for parentNode

                  // Summary elements height above current
                  topFixHeights[i] = topFixHeights[i - 1] || 0; // Not zero because of negative margins
                  topRealHeights[i] =
                      topRealHeights[i - 1] || Math.min(headerTops[i], 0);
              ...
              if (params.limiter && elements[0]) {
                  ...
                  if (this.track && this.track != this.scroller) {
                      pos = {};
                      pos[this.origin.pos] =
                          elements[0].parentNode[this.origin.offset];
          ...
          if (elements) {
              ...
              for (i = 0; i < elements.length; i++) {
                  ...
                  if (
                      ...
                      headerTops[i] - this.pos() >
                      topRealHeights[i] + viewPortSize - params.radius
                  ) {
                  ...
                  gradState = false;
                  if (
                      headerTops[i] - this.pos() < topRealHeights[i] ||
                      headerTops[i] - this.pos() >
              ...
              if (change) {
                  ...
                  for (i = 0; i < elements.length; i++) {
                      if (fixFlag[i] == 1 && params.past) {
                          this.$(elements[i])
                              .addClass(params.past)
                              .removeClass(params.future);
                      }

                      if (fixFlag[i] == 2 && params.future) {
                          this.$(elements[i])
                              .addClass(params.future)
                              .removeClass(params.past);
                      }
                      ...
                      if (fixFlag[i] == 3) {
                          if (params.future || params.past)
                              this.$(elements[i])
                                  ...
                                  .removeClass(params.future);
                          if (params.inside)
                              this.$(elements[i]).addClass(params.inside);
                      ...
                      if (
                          ...
                          this.$(elements[i])
                              .addClass(params.before)
                              .removeClass(params.after); // Last top fixed header
                      } else if (
                          fixFlag[i] != fixFlag[i - 1] &&
                          fixFlag[i] == 2 &&
                          params.after
                          ...
                          this.$(elements[i])
                              .addClass(params.after)
                              .removeClass(params.before); // First bottom fixed header
                      } else {
                          this.$(elements[i])
                              .removeClass(params.before)
                              .removeClass(params.after);
                      }
