import { 
  ...
  fetch, 
  getTableInfoList,
  getCommercialInfoFields } from './service';
...
const Model = {
  ...
  effects: {
    ...
    *getCommercialFields({ payload }, { call, put }) {
      const response = yield call(getCommercialInfoFields, payload);
      yield put({
        type: 'getCommercialInfoFields',
        payload: response,
      });
    },
    *add({ payload, callback }, { call, put }) {
      const response = yield call(addCommercialInfo, payload);
      yield put({
        type: 'save',
        payload: response,
      });
    ...
    *update({ payload, callback }, { call, put }) {
      const response = yield call(updateCommercialInfo, payload);
      yield put({
        type: 'save',
        payload: response,
      });
    ...
    *delete({ payload, callback }, { call, put }) {
      const response = yield call(deleteCommercialInfo, payload);
      yield put({
        type: 'save',
        payload: response,
      });
  ...
  reducers: {
    ...
    getCommercialInfoFields(state, action) {
      return {
        ...state,
